 ...
 *
 * `strictTypeChecked` is deliberate: CLAUDE.md forbids `any` and `@ts-ignore`, and only the
 * type-aware rules can actually enforce that.
 *
  ...
  return tseslint.config(
    ...
    js.configs.recommended,
    {
      ...
      rules: {
        ...
        // --- accessibility: the prototypes use <div onClick> everywhere and we do not ---
        ...
        'import-x/order': [
          'error',
          {
            ...
            pathGroups: [{ pattern: '@charva/**', group: 'internal', position: 'before' }],
